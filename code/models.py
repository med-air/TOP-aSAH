...
def similarity_matrix(phi_im,phi_cli,t, traumatic):
    ...
    for index in index_0[0]:
        for index_ in index_1[0]:
            similarity_matrix_01_im[index,index_] = cal_similarity(phi_im_norm[index],phi_im_norm[index_])
            similarity_matrix_01_cli[index,index_] = cal_similarity(phi_cli_norm[index],phi_cli_norm[index_])
    ...
    for index in index_0[0]:
        for index_ in index_2[0]:
            similarity_matrix_02_im[index,index_] = cal_similarity(phi_im_norm[index],phi_im_norm[index_])
            similarity_matrix_02_cli[index,index_] = cal_similarity(phi_cli_norm[index],phi_cli_norm[index_])
    ...
    for index in index_1[0]:
        for index_ in index_2[0]:
            similarity_matrix_12_im[index,index_] = cal_similarity(phi_im_norm[index],phi_im_norm[index_])
            similarity_matrix_12_cli[index,index_] = cal_similarity(phi_cli_norm[index],phi_cli_norm[index_])
    ...
    phi_sim_im_ab = cal_similarity(phi_im_norm[pairs_im[0]],phi_im_norm[pairs_im[1]])
    phi_sim_im_ac = cal_similarity(phi_im_norm[pairs_im[0]],phi_im_norm[pairs_im[2]])
    phi_sim_im_bc = cal_similarity(phi_im_norm[pairs_im[1]],phi_im_norm[pairs_im[2]])
    
    phi_sim_im_de = cal_similarity(phi_im_norm[pairs_im[3]],phi_im_norm[pairs_im[4]])
    phi_sim_im_df = cal_similarity(phi_im_norm[pairs_im[3]],phi_im_norm[pairs_im[5]])
    phi_sim_im_ef = cal_similarity(phi_im_norm[pairs_im[4]],phi_im_norm[pairs_im[5]])
    
    phi_sim_im_gh = cal_similarity(phi_im_norm[pairs_im[6]],phi_im_norm[pairs_im[7]])
    phi_sim_im_gi = cal_similarity(phi_im_norm[pairs_im[6]],phi_im_norm[pairs_im[8]])
    phi_sim_im_hi = cal_similarity(phi_im_norm[pairs_im[7]],phi_im_norm[pairs_im[8]])
    
    phi_sim_cli_ab = cal_similarity(phi_cli_norm[pairs_cli[0]],phi_cli_norm[pairs_cli[1]])
    phi_sim_cli_ac = cal_similarity(phi_cli_norm[pairs_cli[0]],phi_cli_norm[pairs_cli[2]])
    phi_sim_cli_bc = cal_similarity(phi_cli_norm[pairs_cli[1]],phi_cli_norm[pairs_cli[2]])
    
    phi_sim_cli_de = cal_similarity(phi_cli_norm[pairs_cli[3]],phi_cli_norm[pairs_cli[4]])
    phi_sim_cli_df = cal_similarity(phi_cli_norm[pairs_cli[3]],phi_cli_norm[pairs_cli[5]])
    phi_sim_cli_ef = cal_similarity(phi_cli_norm[pairs_cli[4]],phi_cli_norm[pairs_cli[5]])
    
    phi_sim_cli_gh = cal_similarity(phi_cli_norm[pairs_cli[6]],phi_cli_norm[pairs_cli[7]])
    phi_sim_cli_gi = cal_similarity(phi_cli_norm[pairs_cli[6]],phi_cli_norm[pairs_cli[8]])
    phi_sim_cli_hi = cal_similarity(phi_cli_norm[pairs_cli[7]],phi_cli_norm[pairs_cli[8]])
...
class DragonNet_3dimg_3cls_ours3(nn.Module):
    ...
    def forward(self, cli, t_true, image, traumatic, is_test = False, is_tsne = False):
        ...
        if not is_test:
            pairs_im, pairs_cli, sim_im_hub, sim_cli_hub = similarity_matrix(psi_im, psi_cli, t_true, traumatic)
